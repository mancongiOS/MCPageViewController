...
//  MCLoading
//
//  Created by MC on 13/12/18.
//  Copyright (c) 2018年 com.MC. All rights reserved.
//
...
extension UIResponder {
    ...
    func pleaseWaitWithImages(_ imageNames: Array<UIImage>, timeInterval: Int) -> UIWindow{
        return MCLoading.wait(imageNames, timeInterval: timeInterval)
    }
    // api changed from v3.3
    @discardableResult
    func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: CGFloat = 1) -> UIWindow{
        return MCLoading.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: CGFloat = 3) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: CGFloat = 3) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: CGFloat = 3) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // old apis
    @discardableResult
    func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func infoNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return MCLoading.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: CGFloat = 3) -> UIWindow{
        return MCLoading.showNoticeWithText(type, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func pleaseWait() -> UIWindow{
        return MCLoading.wait()
    }
    @discardableResult
    func noticeOnlyText(_ text: String) -> UIWindow{
        return MCLoading.showText(text)
    }
    func clearAllNotice() {
        MCLoading.clear()
    }
...
public class MCLoading: NSObject {
    
    fileprivate static var windows = Array<UIWindow?>()
    fileprivate static let rv = UIApplication.shared.keyWindow?.subviews.first as UIView?
    fileprivate static var timer: DispatchSource!
    fileprivate static var timerTimes = 0
    ...
    @discardableResult
    static func noticeOnStatusBar(_ text: String, autoClear: Bool, autoClearTime: CGFloat,font:CGFloat=13) -> UIWindow {
    ...
    @discardableResult
    static func showText(_ text: String, autoClear: Bool=true, autoClearTime: CGFloat=2,font:CGFloat=14) -> UIWindow {
        let window = UIWindow()
        window.backgroundColor = UIColor.clear
        let mainView = UIView()
        mainView.layer.cornerRadius = 12
    ...
    @discardableResult
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: CGFloat,font:CGFloat = 14) -> UIWindow {
        ...
        switch type {
        case .success:
            image = MCLoadingSDK.imageOfCheckmark
        case .error:
            image = MCLoadingSDK.imageOfCross
        case .info:
            image = MCLoadingSDK.imageOfInfo
        }
...
class MCLoadingSDK {
    ...
    fileprivate class func draw(_ type: NoticeType) {
    ...
    fileprivate class var imageOfCheckmark: UIImage {
        ...
        MCLoadingSDK.draw(NoticeType.success)
    ...
    fileprivate class var imageOfCross: UIImage {
        ...
        MCLoadingSDK.draw(NoticeType.error)
    ...
    fileprivate class var imageOfInfo: UIImage {
        ...
        MCLoadingSDK.draw(NoticeType.info)
...
extension UIWindow{
    func hide() {
        MCLoading.hideNotice(self)
    }
}

fileprivate extension Selector {
    static let hideNotice = #selector(MCLoading.hideNotice(_:))
}

@objc extension MCLoading {
