...
extension String {
     ...
     * 计算字符串的宽度
     */
    public func MCGetWidth(font: CGFloat, height: CGFloat) -> CGFloat {
        return MCGetWidth(font: UIFont.systemFont(ofSize: font), height: height)
    }
    public func MCGetWidth(font:UIFont,height:CGFloat) -> CGFloat {
